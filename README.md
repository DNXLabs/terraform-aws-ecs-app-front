...
This module is designed to be used with `DNXLabs/terraform-aws-ecs` (https://github.com/DNXLabs/terraform-aws-ecs). and `DNXLabs/terraform-aws-ecs-app` (https://github.com/DNXLabs/terraform-aws-ecs-app) .
