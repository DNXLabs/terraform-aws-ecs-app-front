...
| cloudfront\_origin\_ssl\_protocols | The SSL/TLS protocols that CloudFront can use when connecting to the origin. | `list(string)` | <pre>[<br>  "SSLv3",<br>  "TLSv1.1",<br>  "TLSv1.2",<br>  "TLSv1"<br>]</pre> | no |
